Conceptos básicos 3/11

- [x] Direcciones IP (IPV4 e IPV6)
- [x] Direcciones MAC (OUI y NIC)
- [x] Protocolos comunes (UDP, TCP) y el famoso Three-Way Handshake
- [x] El modelo OSI – ¿En qué consiste y cómo se estructura la actividad de red en capas?
