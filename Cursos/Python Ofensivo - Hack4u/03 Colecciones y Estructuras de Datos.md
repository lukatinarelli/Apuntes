...
- [📦 Listas](#-listas)
	...
	- [🛠️ Operaciones básicas con listas](#%EF%B8%8F-operaciones-básicas-con-listas)
	- [🚀 Comprensiones de listas](#-comprensiones-de-listas)
	- [📚 Métodos útiles de listas](#-métodos-útiles-de-listas)
	- [✔️ Buenas prácticas](#%EF%B8%8F-buenas-prácticas)
- [📚 Tuplas](#-tuplas)
	- [⭐ Características principales](#-características-principales-1)
	- [🛠️ Operaciones con tuplas](#%EF%B8%8F-operaciones-con-tuplas)
	- [🧰 Usos comunes de las tuplas](#-usos-comunes-de-las-tuplas)
	- [✔️ Buenas prácticas](#%EF%B8%8F-buenas-prácticas-1)
- [🔷 Conjuntos (Sets)](#-conjuntos-sets)
	- [⭐ Características principales](#-características-principales-2)
	- [🛠️ Operaciones básicas con sets](#%EF%B8%8F-operaciones-básicas-con-sets)
	- [🔗 Operaciones entre conjuntos](#-operaciones-entre-conjuntos)
	- [🔍 Pruebas de pertenencia](#-pruebas-de-pertenencia)
	- [🧱 Conjuntos inmutables: `frozenset`](#-conjuntos-inmutables-frozenset)
	- [🧰 Usos habituales de los conjuntos](#-usos-habituales-de-los-conjuntos)
	- [✔️ Buenas prácticas](#%EF%B8%8F-buenas-prácticas-2)
- [📘 Diccionarios](#-diccionarios)
	- [⭐ Características principales](#-características-principales-3)
	- [🛠️ Operaciones básicas](#%EF%B8%8F-operaciones-básicas)
	- [📚 Métodos útiles de diccionarios](#-métodos-útiles-de-diccionarios)
	- [🚀 Comprensiones de diccionarios](#-comprensiones-de-diccionarios)
	- [🧰 Usos comunes](#-usos-comunes)
	- [✔️ Buenas prácticas](#%EF%B8%8F-buenas-prácticas-3)
