...
_Xcode_ es un **Entorno de Desarrollo Integrado** (IDE) creado por [Apple](https://www.browserstack.com/guide/what-is-xcode) para que los desarrolladores puedan crear aplicaciones para todas sus plataformas, incluyendo iOS, macOS, watchOS y tvOS. Proporciona un conjunto completo de herramientas, como un editor de código, un diseñador de interfaces visuales y simuladores, para escribir, depurar y probar software en un solo lugar. Está disponible de forma gratuita en la [Mac App Store](https://developer.apple.com/la/support/xcode/).
# Instalación
Para instalar _Xcode_ es muy sencillo. Abrimos la Mac App Store y buscamos por "Xcode". Nos aparecerán muchas herramientas pero la que tenemos que instalar es la creada por "Apple" con mas de 12k opiniones. https://apps.apple.com/es/app/xcode/id497799835?mt=12.
[foto] 
Y obtenemos la aplicación. Recuerda tener un mínimo de 12.1GB de espacio disponible que es el tamaño base de la aplicación.
